 ...
 * @return     true     La serializacion de los datos se realizó correctamente
 ...
 * 
 * Esta función recibe un puntero a una estructura con los datos de los
 * alumnos y devuelve los datos de esa estructura en una cadena JSON 
